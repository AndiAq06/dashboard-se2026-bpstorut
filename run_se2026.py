...
def run_unified_scraper():
    ...
    with sync_playwright() as p:
        ...
        search_selector = 'input[placeholder="Cari survei..."], input[type="search"], label:has-text("Search") input'
        ...
        try:
            page.locator(search_selector).first.wait_for(state="visible", timeout=45000)
        ...
        page.locator(search_selector).first.wait_for(state="visible", timeout=30000)
        ...
        if run_mode in ["full", "data"]:
            ...
            # Always overwrite/initialize detail CSV for bulk fetch
            ...
            # 7. Load SLS code to PPL email mapping for resolving Searched Email column
